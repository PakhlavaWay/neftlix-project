...
const Main = () => {
  return (
    <section
      style={{
        background:
          "linear-gradient(rgba(0, 0, 0, 0.50), rgba(0, 0, 0, 0.50)), url(https://occ-0-6-7.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABbA2qlM00ASRGw8sEWj8PSS9Z4UbRvLE_USbvlVlevtVhPeWtAX0mSNUEp3caMxYTRQLbwvap21W2eh_ODPD3G-d2UaJFP4R0gOL.webp?r=a97) center 50%",
        height: "50vw",
        // minHeight: "auto"
    ...
    >
      <div className="wrapper !w-[42%] !ml-16 flex h-full flex-col gap-4 pt-24">
        ...
        <div className="flex gap-2 w-1/2">
            ...
            <button className="rounded-[4px] text-white !text-lg font-bold px-4 py-2 w-38 gap-2 !bg-zinc-500 flex items-center"><InfoIcon />More Info</button>
        </div>
        <div className="flex gap-2 items-center absolute right-0 top-[34vw]">
